...
<!--        <div class="icon_wrapper">
        ...
        <form id="contact_form" action="#" method="post">
          <div class="name">
            <label for="name" />
            <input id="name_input" type="text" placeholder="My name is" name="name" required>
          </div>
          <div class="email">
            <label for="email" />
            <input id="email_input" type="email" placeholder="My e-mail is" name="email" required>
          </div>
          <div class="telephone">
            <label for="name" />
            <input id="telephone_input" type="text" placeholder="My number is" name="telephone" required>
          </div>
          <div class="subject">
            <label for="subject" />
            <select id="subject_input" placeholder="Subject line" name="subject" required>
          ...
          <div class="submit">
            <input id="form_button" type="submit" value="Send Message">
          </div>
        </form><!-- // End form -->
      </div><!-- // End #container -->
    </div>
